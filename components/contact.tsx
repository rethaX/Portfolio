              ...
              >
                <Card className="overflow-hidden border-none shadow-md bg-white h-full">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    <div className="mb-4 bg-gradient-to-br from-primary/20 to-purple-600/20 p-4 rounded-full">
                      {info.icon}
                    </div>
                    <div>
                      <h3 className="font-bold text-lg mb-2 text-gray-900">{info.title}</h3>
                      {info.link ? (
                        <a href={info.link} className="text-gray-700 hover:text-primary transition-colors">
                          {info.value}
                        </a>
                      ) : (
              ...
              <CardContent className="p-6">
                ...
                <div className="flex justify-center space-x-6">
                  <a
                    ...
                    className="w-12 h-12 rounded-full bg-gradient-to-br from-primary/20 to-purple-600/20 flex items-center justify-center text-primary hover:from-primary hover:to-purple-600 hover:text-white transition-colors"
                    aria-label="GitHub"
                  >
                    <svg
