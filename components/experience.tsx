  ...
  const experiences = [
    {
      ...
      responsibilities: [
        ...
        "Developed scripts to automate the creation of Docker container and images for deploying Payara Server on AWS EC2 instances.",
