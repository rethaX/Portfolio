  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        primary: {
          DEFAULT: "hsl(0, 0%, 0%)", // Black color for primary
          foreground: "hsl(0, 0%, 100%)", // White text on black background
        },
        secondary: {
