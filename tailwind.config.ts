  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        primary: {
          DEFAULT: "hsl(270, 70%, 40%)", // Purple color for primary
          foreground: "hsl(0, 0%, 100%)", // White text on purple background
        },
        secondary: {
      ...
      backgroundImage: {
        ...
        "diagonal-pattern":
          "url(\"data:image/svg+xml,%3Csvg width='6' height='6' viewBox='0 0 6 6' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%239C92AC' fill-opacity='0.05' fill-rule='evenodd'%3E%3Cpath d='M5 0h1L0 5v1H5V0zm1 5v1H5v-1h1z'/%3E%3C/g%3E%3C/svg%3E\")",
      },
      borderRadius: {
        lg: "var(--radius)",
